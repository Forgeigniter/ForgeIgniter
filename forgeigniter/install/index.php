		...
		<div class="row">
			...
			<div class="col-md-8">
			  <div id="right-content">
					...
					<?php // Version Check
						// We should really be using 7.4 or 8
						if (version_compare(phpversion(), '7.0', '<')) {
						echo '<p class="error"> Please update PHP on the server to at least 7.0 to make things work correctly your current version is:'.PHP_VERSION.'</p>' ;
						$versionCheck = false;
					}else {
